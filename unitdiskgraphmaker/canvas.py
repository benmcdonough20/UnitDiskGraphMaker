...
from PyQt6.QtGui import QColorConstants, QPen, QPainter, QBrush, QLinearGradient, QImage, QGradient
...
class SmartCanvas(QFrame):
    ...
    def __init__(self, gui):
        ...
        self.potential = np.zeros((round(SCALE*(MAXWIDTH+2)), round(SCALE*(MAXHEIGHT+2))))
